defmodule Ros.Service.DataSocketClient do
  @moduledoc false
  ...
  def init(url) do
    {:connect, url, [], %{transport: nil}}
  end

  def handle_connected(transport, state) do
    Logger.info("connected")
    GenSocketClient.join(transport, "rosdata:read")
...
#  end
  ...
  def handle_call({:new_data, orderid}, _from, transport, state) do
    Logger.info("handle call :new_data")
    GenSocketClient.push(transport, "rosdata:read", "new_data", %{body: orderid})
    {:reply, :ok, state}
  end
